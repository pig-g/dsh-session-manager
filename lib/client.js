window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var ArchivedSessions_module_css_default = {
			...
			"transcript": "SZWjAa_transcript",
			"msgRole": "SZWjAa_msgRole",
		...
		*/
						...
						data !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: ArchivedSessions_module_css_default.detailSection,
									children: t("transcript")
								}),
								(data.messages ?? []).length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: ArchivedSessions_module_css_default.hint,
									children: t("noTranscript")
								}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: ArchivedSessions_module_css_default.transcript,
									children: (data.messages ?? []).map((m, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: ArchivedSessions_module_css_default.msg,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: ArchivedSessions_module_css_default.msgRole,
											children: m.role === "user" ? t("roleUser") : t("roleAssistant")
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: ArchivedSessions_module_css_default.msgText,
											children: m.text
										})]
									}, index))
								}),
		...
		const dictionaries = {
			...
			en: {
				...
				noTranscript: "No conversation text",
				roleUser: "User",
